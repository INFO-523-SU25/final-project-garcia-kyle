...
.project-timeline {
  ...
  line-height: 1.3;         /* Matches paragraph line spacing closely */
}
.project-timeline th, .project-timeline td {
  border: 1px solid #ccc;
  padding: 5px 6px;         /* Vertical 5px, horizontal 6px */
  vertical-align: top;
}
.project-timeline th {
...
.project-timeline td:first-child {
  text-align: center;
  width: 5%;
}
.project-timeline th:nth-child(2) { width: 20%; }
.project-timeline th:nth-child(3) { width: 55%; }
.project-timeline th:nth-child(4) { width: 20%; }
</style>

<table class="project-timeline">
<thead>
<tr>
<th>Week</th>
<th>Task Name</th>
...
<td>Load the dataset, inspect features, validate schema, sanity-check label balance.</td>
<td>Both</td>
</tr>
<tr>
<td>1</td>
<td>Define research questions and proposal</td>
<td>Clarify goals for supervised (XGBoost) and unsupervised (K-Means/DBSCAN) anomaly detection.</td>
<td>Both</td>
</tr>
<tr>
<td>2</td>
<td>EDA &amp; Feature engineering</td>
<td>Explore distributions, correlations, missing data, and outliers; then one-hot encode categoricals, standardize numerics, and remove low-variance/redundant columns to build a reusable pipeline.</td>
<td>David</td>
</tr>
<tr>
<td>3</td>
<td>Supervised model development</td>
<td>Train XGBoost to classify traffic as normal vs. anomalous.</td>
<td>David</td>
</tr>
<tr>
<td>3</td>
<td>Evaluation of supervised models</td>
<td>Use accuracy, precision, recall, F-1, and ROC-AUC to assess performance.</td>
<td>David</td>
</tr>
<tr>
<td>3</td>
<td>Unsupervised model development</td>
<td>Explore K-Means and DBSCAN to cluster traffic and detect anomalies.</td>
<td>Joey</td>
</tr>
<tr>
<td>4</td>
<td>Evaluation of unsupervised models</td>
<td>Compare cluster assignments to labels using Adjusted Rand Index; report silhouette where relevant.</td>
<td>Joey</td>
</tr>
<tr>
<td>4</td>
<td>Comparative analysis</td>
<td>Contrast performance and feature influence across supervised vs. unsupervised approaches.</td>
<td>Both</td>
</tr>
<tr>
<td>5</td>
<td>Final report &amp; presentation</td>
<td>Compile results, figures, and discussion into final deliverables.</td>
<td>Both</td>
</tr>
</tbody>
</table>

...
**Best training F1-score: \~99.81% & Test F1-score: 0.79**\
...
- GMM: 0.307\
**Adjusted Rand Index:**\
- DBSCAN: 0.242 (Closest match to ground truth)\
- KMeans: 0.179\
...
- **K-Means** excels at forming tight clusters\
- DBSCAN is best at matching true anomalies\
- GMM balances both\
...
- **Data Drift:** F1-score highlights train (f1=~98%) and test (f1=~70%) performance metrics\
